...
public class Utility extends ManageBrowser {
    ...
    /**
     * This method will send text on the element
     */
...
//*************************** Window Handle Methods ***************************************//
    ...
    /**
     * This method will find that we switch to RightWindow
     */
...
//    }
    ...
    /**
     * This method will use to hover mouse on the element and click
     */
...
//    }
    ...
    /**
     * This method is used to get attribute of the value
     */
    ...
    public void listOfElementVerify(By by, By by1, String selectOneText, By by3) {
        // Storing product names in the list
    ...
    public void listVerifyInReverseOrder(By by,By by1, String selectOneText, By by3)
    {
        // Storing product names in the list
        List<WebElement> productsElementsList = driver.findElements(by);
        List<String> productNameListBefore = new ArrayList<>();
        for (WebElement value : productsElementsList) {
            productNameListBefore.add(value.getText());
        }
        ...
        // Sort the before name list into Ascending Order
        productNameListBefore.sort(String.CASE_INSENSITIVE_ORDER);// Ascending order
        Collections.reverse(productNameListBefore);
        // Verify the products name display in alphabetical order
        Assert.assertEquals(productNameListBefore, productsNameListAfter);
    }
